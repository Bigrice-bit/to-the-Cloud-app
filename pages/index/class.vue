	...
	<view class="content">
		<view class="wrap">
			<view class="u-tabs-box">
				<u-tabs-swiper activeColor="#43c191" name="cate_name" count="cate_count" ref="tabs" :list="list"
					bar-height="3" bar-width="200" :current="current" @change="change" :is-scroll="false"
