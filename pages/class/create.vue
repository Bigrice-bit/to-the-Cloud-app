...
<!-- 		<view class="content">
		...
		<u-form :model="form" ref="uForm" :error-type="errorType">
				...
				<u-input 	v-model="form.class" 
							placeholder="请输入班级名称"/></u-form-item>
				...
				<u-form-item :label-position="labelPosition" label="学期" prop="team" label-width="150">
					<u-input :border="border" type="select" :select-open="selectShow" v-model="form.team" placeholder="请选择学期" @click="selectShow = true"></u-input>
				</u-form-item>
					<u-form-item :label-position="labelPosition" label="学校院系" prop="school" label-width="150">
						<u-input :border="border" type="select" :select-open="pickerShow" v-model="form.school" placeholder="请选择学校院系" @click="pickerShow = true"></u-input>
					</u-form-item>
				</u-form>
			<view>
				<u-button 
							...
							shape="circle" 
							 class="loginBtn" 
							 @click="submit">创建</u-button>
							 <u-select mode="single-column" :list="selectList" v-model="selectShow" @confirm="selectConfirm"></u-select>
							 <u-select mode="mutil-column" :list="SchoolList" v-model="pickerShow" @confirm="selectconfirm"></u-select>
